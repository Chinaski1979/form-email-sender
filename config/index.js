...
const CONFIG_ENV = {
  ...
  PROPELLA_TOUR_TO_EMAIL: process.env.PROPELLA_TOUR_TO_EMAIL,
  PROPELLA_SPECIAL_FORMS_TO_EMAIL: process.env.PROPELLA_SPECIAL_FORMS_TO_EMAIL,
  ...
  MOBULA_BRIEF_TO_EMAIL: process.env.MOBULA_BRIEF_TO_EMAIL,
